...
WHERE flights.year = 2023 AND flights.month = 7 AND flights.day = 29 AND flights.hour BETWEEN 00 AND 12 AND airports.city = "Fiftyville"
...
AND passport_number IN (
    ...
    JOIN airports
    ON airports.id = flights.origin_airport_id
    WHERE flights.year = 2023 AND flights.month = 7 AND flights.day = 29 AND flights.hour BETWEEN 00 AND 12
